...
<head>
    ...
    <title>轮回后台登录</title>
    <link href="/xmglg/public/static/admin/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="/xmglg/public/static/admin/css/style.min.css" rel="stylesheet">
    <link href="/xmglg/public/static/admin/css/login.min.css" rel="stylesheet">
    <link href="/xmglg/public/static/admin/css/jquery.slider.css" rel="stylesheet">
    <script type="text/javascript" src="/xmglg/public/static/admin/js/jquery.min.js?v=2.1.4"></script>
    <script>
...
<body class="signin">
    ...
    <script type="text/javascript" src="/xmglg/public/static/admin/js/bootstrap.min.js?v=3.3.6"></script>
    <script type="text/javascript" src="/xmglg/public/static/admin/js/jquery.form.js"></script>
    <script type="text/javascript" src="/xmglg/public/static/admin/js/layer/layer.js"></script>
    <script type="text/javascript" src="/xmglg/public/static/admin/js/lunhui.js"></script>
    <script type="text/javascript" src="/xmglg/public/static/admin/js/jquery.slider.min.js"></script>
