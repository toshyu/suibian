                            ...
                            <table id="example" class="display defaultTable" style="width:100%; margin:20px; ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="t_4">
                                            <div class="btn">
                                                <!-- <a href="prosel.php?id=" class="Top">查看</a> --><a href="<?php echo url('proupdate'); ?>?id=<?php echo $vo['id']; ?>" class="modify">编辑</a><a href="<?php echo url('prodelete'); ?>?id=<?php echo $vo['id']; ?>" onclick="return confirm('是否确认删除?')" class="delete">删除</a></div>
                                        </td>
                                    </tr>
