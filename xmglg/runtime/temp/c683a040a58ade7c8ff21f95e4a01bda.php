...
$(document).ready(function() {
    ...
    <script src="/xmglg/public/static/admin/js/hplus.min.js?v=4.1.0"></script>
    <script src="/xmglg/public/static/admin/js/contabs.js"></script>
    <script src="/xmglg/public/static/admin/js/plugins/pace/pace.min.js"></script>
