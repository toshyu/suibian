...
class Project extends Base {
    ...
    public function proupdate() {
        $id = input('param.id');
        if (is_numeric($id) && $id > 0) {
            $list = db('project')->where('id', 'eq', $id)->select();
