...
<body>
    ...
    <div class="layui-form-item">
        <div class="layui-input-inline">
            ...
            <input type=button class="layui-btn layui-btn-info" name='button_export' title='打印' onclick=preview(1) value=打印>
        </div>
    </div>
    </div>
</body>
