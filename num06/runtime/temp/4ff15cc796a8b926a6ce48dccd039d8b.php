<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"E:\PhpStudy\PHPTutorial\WWW\num06/application/index\view\project_cut\projectadd.html";i:1563091226;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
                ...
                <div class="layui-form" lay-filter="project_form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" class="layui-input" name="contract_amount" placeholder="合同金额" disabled>
                            </div>
                        </div>
                        <div class="layui-inline">
                            <div class="layui-form-label">决算额</div>
                            <div class="layui-input-inline">
                                <input type="text" class="layui-input" name="final_amount" placeholder="决算额" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="production" id="production_cost">
                        ...
                        <a href="javascript:;" class="layui-btn layui-btn-xs" lay-submit
                            lay-filter="add_department">添加部门</a>
                        <div class="layui-form-item">
                            <div class="layui-inline">
    ...
    <div id="productionTpl" class="layui-hide">
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                <a href="javascript:;" class="layui-btn layui-btn-sm layui-btn-danger" lay-submit
                    lay-filter="del_department">删除</a>
            </div>
        </div>
    </div>
