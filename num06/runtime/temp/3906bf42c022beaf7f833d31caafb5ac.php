<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\LL\wamp\www\num06/application/index\view\ruleset\setcarrule.html";i:1552644705;}*/ ?>
<!DOCTYPE html>
<html lang="en">

<head>
    <meta charset="UTF-8">
    <title>车险回溯规则设置</title>
...
<body>
    <div class="layui-fluid">
        <div class="layui-card">
            <div class="layui-card-header">车险回溯规则设置</div>
