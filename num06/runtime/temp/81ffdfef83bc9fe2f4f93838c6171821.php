...
<body>
    ...
    <form class="layui-form" action="<?php echo url('index/project/projectAddDo'); ?>" enctype="multipart/form-data" accept-charset="utf-8" onsubmit="document.charset='utf-8';">
