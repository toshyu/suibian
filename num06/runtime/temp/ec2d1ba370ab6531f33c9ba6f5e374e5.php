...
<body>
            ...
            <div class="layui-form">
                <div class="layui-input-inline">
                    <div class="layui-form-item">
                        <input type="text" class="layui-input" name="name" placeholder="项目名称">
                    </div>
                </div>
                <div class="layui-input-inline">
                    <div class="layui-form-item">
    ...
    layui.config({
        ...
        table.render({
            ...
            cols: [
                [
                    ...
                    { field: 'management_cost_all', title: '经营费用总计', minWidth: 150 },
        ...
        form.on("submit(search)", function(obj) {
            obj.field.page = 1
            table.reload("project_cut", {
                where: obj.field
            })
        });

        table.on('tool(project_cut)', function(obj) {
            var id = obj.data.id;
